...
CChartAxisLabel::CChartAxisLabel(CChartView* pParent, bool bHorizontal):CChartObject(pParent)
{
...
void CChartAxisLabel::SetText(CString NewText)  
{ 
	m_strLabelText = NewText; 
	
}

void CChartAxisLabel::SetFont(int nPointSize,CString strFaceName)
{
